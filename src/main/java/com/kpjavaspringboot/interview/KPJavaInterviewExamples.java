...
public class KPJavaInterviewExamples {
    ...
    public static void masterCardInterviewTest() {
        ...
        /**KP :  reverseArray : Reverse an Array of Strings ***/
        reverseStringArray();
        /**KP :  reverseArray : Reverse an Array of Strings ***/
    }
    ...
    /*******************************************
     * Java 8 : reverseArray : Reverse an Array
     *******************************************/
    public static void reverseStringArray() {

        System.out.println("KP : MasterCard Interview : Reverse Array : ");
        System.out.println("Countries : " + Arrays.toString(countries));
        System.out.println("Reverse Countries : " + Arrays.toString(reverseArray(countries)));
    ...
    //Example String
    String[] countries = {"India", "Australia", "US", "UK"};
    int count = countries.length;
    String[] reverseCountries = new String[count];

    public static String[] reverseArray(String[] countries) {

        for (int i = 0; i < count; i++) {
            reverseCountries[i] = countries[count - 1 - i];
        }
